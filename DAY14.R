...
# 단순 선형 회귀 분석
# 다중 선형 회귀 분석
# 둘다 연속형일 때 사용 (단 설명변수 수에 따라 나뉨 )
#
#둘다 훈련DATA( XY둘다있어야 -> 회기식 구해야하니 ) , TESTDATA(X값만 있으면 된다 )
#
## lm() 함수 : 기울기와 절편을 구할때 -> 회귀식 완성 -> 예측가능.  단, 함수사용시  앞이 반응변수 ~ 뒤가 독립변수. A에 따른 B -> A가 독립변수 B가 반응변수
## predict() 함수 : 예측할때 사용.
# 
# 귀무가설 / 대립가설 
#
